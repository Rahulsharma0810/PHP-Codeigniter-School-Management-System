            ...
            <div class="col-sm-8">
                <form class="form-horizontal" role="form" method="post" enctype="multipart/form-data">
                    ...
                    ?>
                        ...
                        <div class="col-sm-6">
                            <?php 
                                echo form_dropdown("usertype", array("Accountant" => $this->lang->line("accountant"), "Librarian" => $this->lang->line("librarian")), set_value("usertype"), "id='usertype' class='form-control'"); 
                            ?>
                        </div>
                        <span class="col-sm-4 control-label">
