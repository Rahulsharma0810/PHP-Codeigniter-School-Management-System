              ...
              <div class="box box-solid">
                ...
                <div class="box-body no-padding">
                  <ul class="nav nav-pills nav-stacked message">
                    <li class="active"><a href="<?=base_url('message/index')?>"><i class="fa fa-inbox"></i> <?=$this->lang->line('inbox')?> <span class="label label-info pull-right"><?=count($unread)?></span></a></li>
                    <li><a href="<?=base_url('message/sent')?>"><i class="fa fa-envelope-o"></i> <?=$this->lang->line('sent')?></a></li>                    
                    <li><a href="<?=base_url('message/fav_message')?>"><i class="fa fa-star-o"></i> <?=$this->lang->line('favorite')?></a></li>                    
              ...
              <div class="box box-primary">
                ...
                <div class="box-body">
                    <div class="margin-bottom">
                        <div class="btn-group">
                            <button id="all" class="btn btn-info btn-sm" data-original-title="Selete mail" data-toggle="tooltip" data-placement="top">
