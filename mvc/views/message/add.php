                            ...
                            <select class="form-control select2" name="to" >
                                ...
                                <?php foreach ($admin as $item): ?>
                                    <?php if($item->usertype == $usertype && $item->email==$email) { ?>
                                        <option value="<?php echo $item->usertype.','.$item->settingID.','.$item->email ?>" disabled><?php echo $item->username ?></option> 
                                    <?php } else {?>     
                                        <option value="<?php echo $item->usertype.','.$item->settingID.','.$item->email ?>"><?php echo $item->username ?></option> 
                                    <?php } ?>                                                                                                      
                                <?php endforeach ?>                                                          
                                </optgroup>
